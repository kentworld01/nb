...
Image {
    ...
    source: "images/titlebar-bg.png"; fillMode: Image.TileHorizontally
    ...
    Column {
        ...
        Item {
            ...
            Button {
                ...
                action: webView.reload; image: "images/view-refresh.png"
            ...
            */
            Text {
                ...
                MouseArea {
                    ...
                    //onClicked: Qt.quit()
                    onClicked: {
                        console.log( webBrowser.urlString )
                        var items = webBrowser.urlString.split( "/" )
            ...
            Button {
                ...
                image: "images/go-jump-locationbar.png"; visible: header.urlChanged
            }
        }
    }
}
